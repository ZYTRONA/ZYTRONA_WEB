...
const DIFFERENTIATORS = [
  ...
  },
  {
    ...
    desc: 'Clear milestone agreements guarantee that deliverables are verified and approved prior to payment releases.'
  },
  {
  ...
  },
  {
    ...
    desc: 'Direct communication with senior engineers, honest sprint timelines, and zero agency overhead.'
  }
]
...
const HOW_IT_WORKS = [
  {
    ...
    desc: 'We analyze your product vision, system architecture requirements, and technical constraints.',
...
const CORE_VALUES = [
  ...
  {
    title: 'Mutual Partnership Respect',
    desc: 'Treating client organizations and engineering teams as equal, long-term partners in building great products.'
  }
]
...
export default function About() {
  const [modalType, setModalType] = useState(null) // 'project'
  ...
  const handleSubmit = async (e) => {
    ...
    const payload = {
      ...projectFormData,
      service: projectFormData.serviceNeeded,
      type: 'Project Consultation Request'
    }
    ...
    <div className="min-h-screen bg-white dark:bg-[#0B0D0F] text-[#4D4D4D] dark:text-[#94A3B8] font-['Inter',sans-serif]">
        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center">
          ...
          <div className="lg:col-span-7 space-y-6">
            ...
            <h1 className="text-4xl sm:text-5xl lg:text-6xl font-extrabold text-[#263238] tracking-tight leading-[1.18]">
              Engineering high-impact web platforms for companies that <br className="hidden sm:inline" />
              <span className="text-[#4CAF4F]">demand real results</span>
            </h1>

            <p className="text-base sm:text-lg text-[#717171] max-w-xl leading-relaxed">
              We engineer high-performance web platforms, SaaS architectures, and UI/UX design systems with direct architect access, 100% IP ownership, and milestone-backed delivery.
            </p>
      ...
      <section className="py-20 px-6 lg:px-16 bg-white border-b border-[#E0E0E0]">
        <div className="max-w-5xl mx-auto space-y-8 text-center">
          ...
          <div className="text-left boxy-card bg-white p-8 sm:p-12 rounded-2xl border border-[#E5E7EB] shadow-sm space-y-5 text-[#717171] text-base sm:text-lg leading-relaxed relative overflow-hidden">
            <p>
              We started because modern software engineering delivery was fundamentally broken. Companies were trapped between bloated agencies with massive overhead and unreliable contractors with zero accountability. At the same time, businesses spent months dealing with missed deadlines and unusable codebases.
            </p>
            <p>
              We knew there was a better way. Our mission is to create a transparent, high-standard engineering studio where proven technical skill meets disciplined execution — eliminating agency overhead and providing guaranteed milestone protection and 100% source-code ownership.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-20 px-6 lg:px-16 bg-[#F5F7FA] border-b border-[#E0E0E0]">
        <div className="max-w-7xl mx-auto space-y-12">
          <div className="text-center space-y-3 max-w-3xl mx-auto">
            ...
            <p className="text-[#717171] text-base">
              Tailored software engineering partnerships for ambitious startups and growing enterprises.
            </p>
          </div>

          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-stretch">
            {/* For Early-Stage & High-Growth Startups */}
            <div className="boxy-card p-8 sm:p-10 bg-white flex flex-col justify-between h-full hover:border-[#4CAF4F]/60 transition-all">
              <div className="flex-1 flex flex-col">
                ...
                <h3 className="text-2xl sm:text-3xl font-extrabold text-[#263238] tracking-tight mb-4">
                  Zero to Launch with Production-Grade Speed
                </h3>
                
                <p className="text-sm text-[#717171] mb-6">
                  Build and launch your MVP or next-generation SaaS with hardened architecture, high conversion rates, and milestone guarantees.
                </p>
                ...
                <ul className="space-y-4 text-sm text-[#717171] mb-8">
                  <li className="flex items-start gap-3">
                    ...
                    <span><strong className="text-[#263238]">Sub-Second Performance:</strong> 98+ Core Web Vitals from day one for superior customer conversion.</span>
                  </li>
                  <li className="flex items-start gap-3">
                    <div className="w-5 h-5 rounded-full bg-[#E8F5E9] flex items-center justify-center shrink-0 mt-0.5 text-[#4CAF4F]">
                      <Check className="w-3.5 h-3.5 stroke-[3]" />
                    </div>
                    <span><strong className="text-[#263238]">Guaranteed Milestone Payouts:</strong> Transparent escrow milestones ensure you only pay for verified deliverables.</span>
                  </li>
                  <li className="flex items-start gap-3">
                    <div className="w-5 h-5 rounded-full bg-[#E8F5E9] flex items-center justify-center shrink-0 mt-0.5 text-[#4CAF4F]">
                      <Check className="w-3.5 h-3.5 stroke-[3]" />
                    </div>
                    <span><strong className="text-[#263238]">Direct Architect Access:</strong> Direct communication with senior software engineers without agency middlemen.</span>
                  </li>
                  <li className="flex items-start gap-3">
                    <div className="w-5 h-5 rounded-full bg-[#E8F5E9] flex items-center justify-center shrink-0 mt-0.5 text-[#4CAF4F]">
                      <Check className="w-3.5 h-3.5 stroke-[3]" />
                    </div>
                    <span><strong className="text-[#263238]">100% IP & Code Ownership:</strong> Full repository rights and unrestricted commercial license upon milestone sign-off.</span>
                  </li>
                </ul>
              </div>
              ...
              <div className="mt-auto pt-6 border-t border-[#F0F0F0]">
                ...
                >
                  <span>Start a Startup Project</span>
                  <ArrowRight className="w-4 h-4" />
                </button>
              </div>
            </div>

            {/* For Enterprises & Growing Brands */}
            <div className="boxy-card p-8 sm:p-10 bg-white flex flex-col justify-between h-full hover:border-[#4CAF4F]/60 transition-all">
              <div className="flex-1 flex flex-col">
                <div className="flex items-center justify-between mb-5">
                  <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-[#E8F5E9] text-[#2E7D32] text-xs font-bold uppercase tracking-wider">
                    <Target className="w-4 h-4" />
                    <span>For Enterprises & Brands</span>
                  </div>
                  <span className="text-xs font-semibold px-2.5 py-1 rounded bg-[#F5F7FA] text-[#717171] border border-[#E0E0E0]">
                    Enterprise SLA
                  </span>
                ...
                <h3 className="text-2xl sm:text-3xl font-extrabold text-[#263238] tracking-tight mb-4">
                  Enterprise Resilience, Scalability & Precision
                </h3>
                
                <p className="text-sm text-[#717171] mb-6">
                  Modernize legacy systems, architect distributed microservices, and deploy tokenized design systems at scale.
                </p>
                ...
                <ul className="space-y-4 text-sm text-[#717171] mb-8">
                  <li className="flex items-start gap-3">
                    ...
                    <span><strong className="text-[#263238]">Senior Engineering Teams:</strong> Dedicated software engineers with deep expertise in React 19, Next.js, and cloud systems.</span>
                  </li>
                  <li className="flex items-start gap-3">
                    <div className="w-5 h-5 rounded-full bg-[#E8F5E9] flex items-center justify-center shrink-0 mt-0.5 text-[#4CAF4F]">
                      <Check className="w-3.5 h-3.5 stroke-[3]" />
                    </div>
                    <span><strong className="text-[#263238]">Predictable Sprint Velocity:</strong> Bi-weekly sprint milestones with automated CI/CD and staging previews.</span>
                  </li>
                  <li className="flex items-start gap-3">
                    <div className="w-5 h-5 rounded-full bg-[#E8F5E9] flex items-center justify-center shrink-0 mt-0.5 text-[#4CAF4F]">
                      <Check className="w-3.5 h-3.5 stroke-[3]" />
                    </div>
                    <span><strong className="text-[#263238]">Zero Operational Disruption:</strong> Seamless integration with existing backend APIs and enterprise infrastructure.</span>
                  </li>
                  <li className="flex items-start gap-3">
                    <div className="w-5 h-5 rounded-full bg-[#E8F5E9] flex items-center justify-center shrink-0 mt-0.5 text-[#4CAF4F]">
                      <Check className="w-3.5 h-3.5 stroke-[3]" />
                    </div>
                    <span><strong className="text-[#263238]">Enterprise Security & SLA:</strong> Mutual NDA protection, code audit pass guarantee, and 99.9% uptime architectures.</span>
                  </li>
                </ul>
              </div>
      ...
      <section className="bg-white py-24 px-6 lg:px-16 text-center">
        <div className="max-w-4xl mx-auto space-y-8">
          <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-[#E8F5E9] text-[#2E7D32] text-xs font-bold uppercase tracking-wider">
            <Sparkles className="w-3.5 h-3.5 text-[#4CAF4F]" />
            <span>Partner with ZYTRONA</span>
          </div>
          ...
          <p className="text-base sm:text-lg text-[#717171] max-w-2xl mx-auto">
            Partner with our senior software engineers and product designers to architect, build, and scale your next digital platform.
          </p>
        ...
        {modalType && (
          ...
          >
            ...
            >
              ...
              <h3 className="text-2xl font-bold text-[#263238] mb-2">Start a Project Consultation</h3>
              <p className="text-sm text-[#717171] mb-6">
                Connect directly with our senior software engineers. 100% IP ownership & milestone protection.
              </p>
              ...
              {formSuccess ? (
                <div className="p-4 bg-[#E8F5E9] border border-[#C8E6C9] rounded-md text-center text-[#2E7D32]">
                  ...
                  <p className="text-xs mt-1">Our engineering team will review your requirements and reply within 24 hours.</p>
                </div>
              ) : (
                <form onSubmit={handleSubmit} className="space-y-4">
                  ...
                  <div>
                    ...
                    <input 
                      type="text" 
                      required 
                      value={projectFormData.fullName}
                      onChange={(e) => setProjectFormData({ ...projectFormData, fullName: e.target.value })}
                  ...
                  <div>
                    <label className="block text-xs font-semibold text-[#263238] uppercase mb-1.5">Service Needed</label>
                    <CustomSelect 
                      value={projectFormData.serviceNeeded}
                      onChange={(val) => setProjectFormData({ ...projectFormData, serviceNeeded: val })}
                      options={[
                  ...
                  <div>
                    ...
                    <textarea 
                      ...
                      onChange={(e) => setProjectFormData({ ...projectFormData, projectScope: e.target.value })}
                      placeholder="Briefly describe your product goals, tech stack, and timeline..."
