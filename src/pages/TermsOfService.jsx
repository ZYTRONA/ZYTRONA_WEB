      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="boxy-card p-8 sm:p-12 bg-white space-y-8 leading-relaxed text-sm sm:text-base text-[#4D4D4D]">
          <div>
            ...
            <p>
              By engaging ZYTRONA for software engineering, web application development, mobile engineering, or UI/UX design systems, you agree to these Terms of Service.
            </p>
          </div>
